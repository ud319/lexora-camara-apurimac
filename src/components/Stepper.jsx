          ...
          return (
            <div key={i} style={{ flex: 1, display: 'flex', alignItems: 'center' }}>
              <div style={{
                ...
                gap: 8,
                padding: '14px 0',
                borderBottom: `2.5px solid ${isActive ? 'var(--lblue)' : isDone ? 'var(--green)' : 'transparent'}`,
                color: isActive ? 'var(--lblue)' : isDone ? 'var(--green)' : 'var(--text-3)',
                transition: 'all .2s',
              }}>
                <div style={{
                  width: 26, height: 26, borderRadius: '50%',
                  border: `1.5px solid ${isActive ? 'var(--lblue)' : isDone ? 'var(--green)' : 'var(--border-2)'}`,
                  background: isActive ? 'var(--lblue)' : isDone ? 'var(--green)' : 'transparent',
